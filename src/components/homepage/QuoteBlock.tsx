      ...
      <div className="flex gap-10 h-full justify-between">
        <div className="w-[40%] text-4xl font-bold uppercase">
          <h2 className="leading-[120%] text-white ml-2">
            <span className="tracking-[2px] bg-gray-400 -ml-5 px-5 rounded-full">подарунок,</span>
            <br />який<br />
            <span className="tracking-[-2.5px]">запам'ятається</span>
          </h2>
        </div>

        <div className="flex flex-col gap-5 w-[50%] text-[#1d1d1d] text-lg font-medium text-white self-end text-right">
          <p className="italic">
