...
export default function HorizontalScreenCard({ data }: { data?: { title: string, description: string, id: number } }) {
  return (
  ...
  return (
    <button
      ...
      className={`
        ...
        text-sm
        flex gap-2 items-center mt-3 hover:opacity-50 transition-all duration-300 self-end`}
    >
